            ...
            try {
                ...
                if (resource === 'auth') {
                    ...
                    if (operation === 'create') {
                        ...
                        const leadData = this.getNodeParameter('leadData', i);
                        const body = {
                        ...
                        const plainDescription = this.getNodeParameter('plainDescription', i);
                        const qs = {};
                        if (plainDescription) {
                        ...
                        const answer = this.getNodeParameter('answer', i);
                        const setVisibleInProfile = this.getNodeParameter('setVisibleInProfile', i);
                        const body = {
                            question,
                            answer,
                            setVisibleInProfile,
                        ...
                        const emailToSearch = this.getNodeParameter('email', i);
                    ...
                    if (operation === 'attach') {
                        ...
                        const layer = this.getNodeParameter('layer', i);
                        const body = {
                            campaignID: campaignId,
                            url: webhookUrl,
                            topic,
                        ...
                        const webhookUrl = this.getNodeParameter('webhookUrl', i);
                        const relatedId = this.getNodeParameter('relatedId', i, '');
                        const qs = {
                            topic,
                            layer,
                            id,
...
async function makeApiRequest(method, endpoint, qs = {}, body = {}, apiKey, email, baseUrl, isFormData = false) {
    var _a, _b, _c, _d;
    ...
    try {
        ...
        console.log('Response body:', (_a = error.response) === null || _a === void 0 ? void 0 : _a.body);
        console.log('Response headers:', (_b = error.response) === null || _b === void 0 ? void 0 : _b.headers);
        ...
        else if ((_d = (_c = error.response) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.error) {
